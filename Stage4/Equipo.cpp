...
void Equipo::updatePosition(double deltaTime){
    ...
    if (m_trackingActive){
        m_history.append(QPointF(m_x,m_y));
    }
}
...
void Equipo::setTracking(bool active){
...
bool Equipo::isTrackingActive() const {return m_trackingActive;}

const QList<QPointF>& Equipo::getHistory() const {return m_history;}